...
from modules.database import importar_contas_excel
...
with aba_classificacao:
    ...
    # Carregar lançamentos (sempre do banco atualizado)
    ...
    if df_lanc.empty:
        ...
        edited_df = st.data_editor(
            df_page,
            num_rows="fixed",  # não permite adicionar linhas novas
            use_container_width=True,
            key="editor_import"
        )
        ...
        if st.button("💾 Salvar alterações", key="save_import"):
            for i, row in edited_df.iterrows():
                ...
                # Se houve mudança na conta_registro
...
with aba_dashboard:
    ...
    if df_filtrado.empty:
        ...
        # ============================================================
        # 🔹 Gráfico de Pizza por Mestre (exclui grupo 6)
        # ============================================================
